...
const PRICE_COLOR_LOW = '#2f4b7c';
const PRICE_COLOR_MEDIUM = '#ff7c43';
const PRICE_COLOR_HIGH = '#d45087';
const PRICE_COLOR_DEFAULT = PRICE_COLOR_LOW;
...
class PriceCard extends HTMLElement {
  ...
  getBackgroundColorForPrice(price) {
    if (price < PRICE_THRESHOLD_LOW) return PRICE_COLOR_LOW;
    if (price >= PRICE_THRESHOLD_LOW && price < PRICE_THRESHOLD_HIGH) return PRICE_COLOR_MEDIUM;
    if (price >= PRICE_THRESHOLD_HIGH) return PRICE_COLOR_HIGH;
  ...
  _getResponsiveOptions() {
    ...
    return {
      ...
      visualMap: {
        ...
        dimension: 1,
        pieces: [
          { lt: PRICE_THRESHOLD_LOW, color: PRICE_COLOR_LOW },
          { gte: PRICE_THRESHOLD_LOW, lt: PRICE_THRESHOLD_HIGH, color: PRICE_COLOR_MEDIUM },
          { gte: PRICE_THRESHOLD_HIGH, color: PRICE_COLOR_HIGH },
        ],
      },
